...
<section>
    <div class="container">
        <div class="curetion_sec">
            <div class="row">
                <div class="col-md-6">
                    <h4>{{ !empty($category) ? $category->name . " (" . $products->total() . ")" : 'Products' }}</h4>
                </div>
                <div class="col-md-6">
                    <div class="desk_view">
                ...
                <div class="content_img" onclick="return redirectToPage('{{ url($product->slug) }}')">
                    ...
                    <div class="product_detail">
                        <p>{{ $product->category->name }}
                            <span><i class="fa fa-usd" aria-hidden="true"></i><strong>{{ $product->amount }}</strong><!-- <b class="align_bttm">(1 Pieces)</b> --></span>
                        </p>
                        <h3>{{ $product->title }} </h3>
