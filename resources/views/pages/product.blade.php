                        ...
                        <div class="desk_view">
                            ...
                            <div class="row">
                                <div class="col-md-5 padd">
                                    <div class="inner_price">
                                        <p>Price <span><i class="fa fa-usd" aria-hidden="true"></i>{{ $product->amount }} <strong class="price_tx">(For 3 Pieces)</strong></span></p>
                                    </div>
                                </div>
                ...
                <div class="product_details_left">
                    <div class="preview col">
                        <div class="app-figure" id="zoom-fig">
                            <a id="Zoom-1" class="MagicZoom" href="{{  url( 'img/product-images/'.$product->primary_image) }}" data-zoom-image-2x="{{  url( 'img/product-images/'.$product->primary_image) }}" data-image-2x="{{  url( 'img/product-images/'.$product->primary_image) }}">
                                <img src="{{  url( 'img/product-images/'.$product->primary_image) }}" alt="" /></a>
                            <div class="selectors">
                                @foreach($productImages as $image)
                                @if(is_string($image))
                                <a data-zoom-id="Zoom-1" href="{{ url('img/product-images/'.trim($image)) }}" data-image-2x="{{ url('img/product-images/'.trim($image)) }}">
                                    <img src="{{ url('img/product-images/'.trim($image)) }}" />
                                </a>
                                @else
                                <a data-zoom-id="Zoom-1" href="{{ url($image->location) }}" data-image-2x="{{ url($image->location) }}">
                                    <img src="{{ url($image->location) }}" />
                                </a>
                                @endif
                                @endforeach
                                <a data-zoom-id="Zoom-1" href="{{  url( 'img/product-images/'.$product->primary_image) }}" data-image-2x="{{  url( 'img/product-images/'.$product->primary_image) }}">
