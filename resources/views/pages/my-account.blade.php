                    ...
                    <div class="myaccount_right tab-content">
                        ...
                        <div class="overview tab-pane fade" id="myaccount7">
                            ...
                            <div class="preferences">
                                ...
                                @foreach($preferences  as $preference)
                                    <div class="preferences1" onclick="return redirectToProduct({{ $preference->id}}, '{{$preference->slug}}')">
                                        <img src="{{ url( $preference->image_primary ? $preference->image_primary->location : '#') }}" class="img-responsive"/>
                                        <p>
                                            <span>
                        ...
                        <div class="overview tab-pane fade" id="myaccount8">
                            ...
                            <div class="coupons_myaccount">
                                <h3>Your pallete credit balance:  <span>A $ 0</span></h3>
