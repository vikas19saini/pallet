<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/fabrics') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/media/upload') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/orders/sample') }}">
                    <i class="nav-icon icon-pencil"></i> Sample Orders </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/orders/production') }}">
