...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('css_new/bootstrap.min.css')); ?>" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('css_new/style.css')); ?>" />
    <!--[if lt IE 8]>
...
<body>
    <div class="container">
        <div class="top_logo">
            <a href="/"><img src="<?php echo e(url('img/logo.svg')); ?>" width="150px" alt=""></a>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="inner_top_img"><img src="<?php echo e(url('img/transition_img.gif')); ?>" alt="" class="img-fluid"></div>
                </div>
            </div>
        </div>
    </section> -->
            ...
            <div class="row m-reverce">
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="inner_top_img">
                        <img src="<?php echo e(url('img/transition_img.gif')); ?>" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
