...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(url('css/pagepiling.css')); ?>" />
    ...
    <body class="landing-page">
        <div id="pagepiling">
            <section class="landing_section1 section" id="section1">  
                <div class="container">
                    <div class="row">
                        <img src="<?php echo e(url('img/logo.png')); ?>" class="img-responsive">
                            ...
                            <div class="work_section">
                                ...
                                <div class="work_icon">
                                    <div class="work_icon1">
                                        <img src="<?php echo e(url('img/work_icon1.png')); ?>" class="img-responsive"/>
                                        <p>Register with us</p>
                                        <span></span>
                                    </div>
                                    <div class="work_icon1">
                                        <img src="<?php echo e(url('img/work_icon2.png')); ?>" class="img-responsive"/>
                                        <p>See our <span>Designs/Products</span></p>
                                        <span class="span2"></span>
                                    </div>
                                    <div class="work_icon1">
                                        <img src="<?php echo e(url('img/work_icon3.png')); ?>" class="img-responsive"/>
                                        <p>Order Samples</p>
                                        <span></span>
                                    </div>
                                    <div class="work_icon1">
                                        <img src="<?php echo e(url('img/work_icon4.png')); ?>" class="img-responsive"/>
                                        <p>Order Bulk</p>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="<?php echo e(url('js/pagepiling.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('js/jquery.countdown.min.js')); ?>"></script>
