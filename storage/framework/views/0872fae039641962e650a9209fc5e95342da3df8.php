        ...
        <div class="container">
            <div class="row">
                ...
                <div class="owl-carousel owl-theme pick_carousel">
                    ...
                    <div class="item" onclick="window.location.href = '<?php echo e(url($product->slug . '/p')); ?>'">
                        <div class="pic_img">
                            <div class="on_img">
                                <img src="<?php echo e(url('img/product-images/' . $product->primary_image)); ?>" class="img-responsive" />
                            </div>
                            <div class="summer_btn"><a href="#"><button>SHOP NOW</button></a></div>
                        </div>
                        <div class="pick_text">
                            <h2><?php echo e($product->title); ?></h2>
                            <p>Price: $<?php echo e($product->amount); ?></p>
                        </div>
                    </div>
